...
const ProjectSect = () => {
    return(
    <section className="px-6 py-12 bg-white" id="projects">
        <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold mb-2 border-l-4 border-green-600 pl-4">Projects & Contribution</h2>
            ...
            {projects.map((proj, i) => (
                ...
                <div
                key={i}
                className="relative group flex items-start gap-4 p-4 border rounded-md shadow-sm bg-[#fafafa] 
                ...
                {proj.showButton && (
                    ...
                    <a href={proj.link} target="_blank">
                        <button className="bg-gray-800 text-white px-4 py-2 rounded-md
                                            flex items-center gap-2 hover:bg-gray-900">
                            <FaAngleRight />
                            View Project
                        </button>
                    </a>
