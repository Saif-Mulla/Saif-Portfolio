 ...
 <section className="w-full bg-[#fafafa] py-12">
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <div className="md:w-1/2 w-full space-y-4">
          <h1 className="text-4xl font-bold text-gray-900">Saif Mulla</h1>
          <h2 className="text-xl text-gray-500">Software engineer, Tech Enthusiast, Life Long Learner.</h2>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pt-4">
            ...
            <a href="/Saif-Mulla-Resume.pdf" download="Saif-Mulla-Resume.pdf" className="flex items-center bg-gray-800 text-white px-5 py-2 rounded-md hover:bg-gray-900 transition">
